clang++ main.cpp kcore.cu -c --cuda-path=/usr/local/cuda-10.1 --cuda-gpu-arch=sm_61 -L/usr/local/cuda-10.1/lib64 -lcudart_static -ldl -lrt -pthread -save-temps -v
clang++ -emit-llvm main.cpp --cuda-gpu-arch=sm_61 -O3 -c

/data/jchen/open_source_template/build/compilation/kernelTranslator kcore-cuda-nvptx64-nvidia-cuda-sm_61.bc kernel.bc 
/data/jchen/open_source_template/build/compilation/hostTranslator kcore-host-x86_64-unknown-linux-gnu.bc host.bc
